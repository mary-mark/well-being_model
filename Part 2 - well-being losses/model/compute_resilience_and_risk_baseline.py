...
if __name__ == '__main__':
    ...
    if myCountry == 'BA':
        ...
        output_folder = 'policy - baseline'
        pds_str = 'no'
        debug = True
        labourIncome = True
        pol_str ='_baseline'# ('_baseline',no_code','retrofit','no_UI','UI_2yrs','no_ins','ins50_15',_ins_rich_50)
        suffix = '_baseline'# ('_baseline',no_code','retrofit','no_ins','ins50_15',_ins_rich_50)
        nsims = 4
